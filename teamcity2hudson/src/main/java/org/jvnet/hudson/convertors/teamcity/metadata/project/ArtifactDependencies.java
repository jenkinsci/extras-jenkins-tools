...
public class ArtifactDependencies
{
    ...
    private List<ArtifactDependency> dependency;


    public ArtifactDependencies()
    {
    }

    public List<ArtifactDependency> getDependency()
    {
        return dependency;
    }

    public void setDependency(List<ArtifactDependency> dependency)
    {
